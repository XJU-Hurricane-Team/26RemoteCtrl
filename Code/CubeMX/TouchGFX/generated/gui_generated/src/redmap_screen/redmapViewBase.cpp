    ...
    frameCountUPdate2Interval(0)
{
    ...
    redsendpoint.setPosition(9, 12, 110, 36);
    redsendpoint.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    redsendpoint.setLinespacing(0);
    Unicode::snprintf(redsendpointBuffer, REDSENDPOINT_SIZE, "%s", touchgfx::TypedText(T_REDSENDPOINT).getText());
    redsendpoint.setWildcard(redsendpointBuffer);
    redsendpoint.setTypedText(touchgfx::TypedText(T___SINGLEUSE_32CZ));
    container3.add(redsendpoint);

    redchoosepoint.setPosition(32, 54, 64, 42);
