...
uint8_t spi5_init(uint32_t mode, spi_clk_mode_t clk_mode, uint32_t data_size,
    ...
    HAL_NVIC_SetPriority(SPI5_RX_DMA_IRQn, SPI5_RX_DMA_IT_PRIORITY,
                         SPI5_RX_DMA_IT_SUB);
    ...
    HAL_NVIC_SetPriority(SPI5_TX_DMA_IRQn, SPI5_TX_DMA_IT_PRIORITY,
                         SPI5_TX_DMA_IT_SUB);
...
uint8_t spi6_init(uint32_t mode, spi_clk_mode_t clk_mode, uint32_t data_size,
    ...
    HAL_NVIC_SetPriority(SPI6_RX_DMA_IRQn, SPI6_RX_DMA_IT_PRIORITY,
                         SPI6_RX_DMA_IT_SUB);
    ...
    HAL_NVIC_SetPriority(SPI6_TX_DMA_IRQn, SPI6_TX_DMA_IT_PRIORITY,
                         SPI6_TX_DMA_IT_SUB);
...
static DMA_HandleTypeDef qspi_dma_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_QUADSPI,
             ...
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_NORMAL,
             .Direction = QUADSPI1_DMA_DIRECTION.Priority =
                 QUADSPI1_DMA_PRIORITY}};
#endif /* QUADSPI_DMA */
